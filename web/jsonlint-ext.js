 ...
 * MIT License
**/
var jsonlint = (function(){var require=true,module=false;var exports={};/* parser generated by jison 0.4.15 */
/*
...
case 13:
this.$ = {};
          if(isLoc()) this.$._loc = _$[$0-1];//MOD:locInfo empty obj
        
break;
case 14:
this.$ = $$[$0-1];
          if(isLoc()) this.$._loc['_this'] = _$[$0-1];//MOD:locInfo obj
        
break;
case 15:
this.$ = [$$[$0-2], $$[$0]];
          if(isLoc()) this.$._loc = [_$[$0-2], _$[$0]];//MOD:locInfo member&value
        
break;
case 16:
this.$ = {}; this.$[$$[$0][0]] = $$[$0][1];
          if(isLoc()){
            this.$._loc = _$[$0];//MOD:locInfo member
            this.$._loc[ '_' + $$[$0][0] ] = $$[$0]._loc;//MOD:locInfo member
          }
...
case 17:
          ...
          if(isStrict()){//MOD: "strict" mode: reject duplicate key entries
            ...
            if(typeof $$[$0-2][$$[$0][0]] !== 'undefined'){
              ...
              var pos = $$[$0]._loc? $$[$0]._loc[0] : _$[$0];
              
              var errStr = 'Parse error in "strict" mode on line '+pos.first_line+': Duplicate property "'+$$[$0][0]+'"';
          ...
          if(isLoc()) this.$._loc[ '_' + $$[$0][0] ] = $$[$0]._loc;//MOD:locInfo member-list
        
break;
case 18:
this.$ = [];
          if(isLoc()) this.$._loc = [_$[$0-1], _$[$0]];//MOD:locInfo empty array
        
break;
case 19:
this.$ = $$[$0-1];
          if(isLoc()) this.$._loc['_this'] = [_$[$0-2], _$[$0]];//MOD:locInfo array
        
break;
case 20:
this.$ = [$$[$0]];
          if(isLoc()) this.$._loc = {'_i0': _$[$0]};//MOD:locInfo array-entry
        
break;
case 21:
this.$ = $$[$0-2]; $$[$0-2].push($$[$0]);
         if(isLoc())  this.$._loc[ '_i' +  (this.$.length - 1) ] = _$[$0];//MOD:locInfo array-list-entry
