...
define(['appUtil', 'jsonlint', 'esprima', 'grammarValidator', 'parseOptions'],
		function(util, jsonparser, jsparser, GrammarValidator, options){
	...
	function _createValidator(view, editor, errorMarkerId, warningMarkerId, infoMarkerId){
		...
		return function validateJsonGrammarImpl(isForceValidation) {
			...
			try {
				...
				jsonparser.setLocEnabled(true);//<- always compile with loc-info (for marking / folding)
			...
			//FIXME DISABLE grammar-validator:///////////////////////////////////////////////////////////////
			return;
